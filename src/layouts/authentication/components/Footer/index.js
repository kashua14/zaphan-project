      ...
      <Container>
        ...
        >
          <MDBox
            ...
            fontSize={size.sm}
          >
            &copy; {new Date().getFullYear()}, CPHL
          </MDBox>
          <MDBox
            component="ul"
            sx={({ breakpoints }) => ({
          ...
          >
            ...
            {/* <MDBox component="li" px={2} lineHeight={1}>
              <Link
                href="https://play.google.com/store/apps/details?id=com.mis.alpha_App"
                target="_blank"
              >
                <MDTypography
                  variant="button"
                ...
                >
                  <img
                    alt="android logo"
                    style={{ width: "auto", height: "35px", marginLeft: "5px" }}
                    src={android}
                  />
                  <p style={{ marginTop: "-30px", marginLeft: "45px" }}>Android App</p>
                </MDTypography>
              </Link>
            </MDBox> */}
            {/* <MDBox component="li" px={2} lineHeight={1}>
