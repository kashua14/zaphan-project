...
function Sidenav({ setCurrentPage, clearedBioInfo, currentPage,sidenavItems }) {
  ...
  //   // { icon: "place", label: "Location", href: "location", page: 3},
  //   { icon: "support",label: "Treatments",href: "treatments",page: 4},
  //   { icon: "paid", label: "Payments", href: "payments", page: 5 },
  //   { icon: "attachment", label: "Attachments", href: "attachments", page: 6 },
